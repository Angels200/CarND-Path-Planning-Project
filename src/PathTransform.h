...
#ifndef PATHTRANSFORM_H_
#define PATHTRANSFORM_H_
...
class PathTransform{
  ...
  public:
	PathTransform(std::string file_path, const double distance);
    ...
    **/
    ...
    std::vector<double> frenetToxy(const double s, const double d) const;
    /**
    ...
    SimPoints compute(JMT jmt_s, JMT jmt_d, const double t, const int n) const;
